...
#ifdef _MSC_VER
    /* Use slightly different expression for MSC to silence
     * compiler error C4146: unary minus operator applied to
     * unsigned type, result still unsigned */
    volatile unsigned int mask = (unsigned int)(-(int)cond);
#else
